...
class AppWidgets {
  ...
  Widget title(String span1Text,{String span2Text='',Color span1Color= Colors.white,Color span2Color= Colors.black }) {
    return RichText(
  ...
  Widget customButton(String buttonLabel,Color labelColor , VoidCallback onTapFunction,{List<Color> gradientColors, double width = 40}) {
    return Container(
